    ...
    private void DialogSelectOption(){
        ...
        ab.setSingleChoiceItems(item, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                //각 리스트를 선택했을 때
                final String option[] = {"시/구 단위", "동 단위"};
                AlertDialog.Builder ab2 = new AlertDialog.Builder(MapsActivity.this);
                ab2.setTitle("서비스를 원하는 단위를 선택하세요.");
                ab2.setSingleChoiceItems(option, 0, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //각 리스트를 선택했을 때
