...
public class SearchHotel extends Activity implements View.OnClickListener {
    ...
    private void clickSearchButton() {
        ...
        String[] strData = splitSpace(searchHotel.getText().toString());
        String[] address;
        String hotel;

        for(int i = 0; i < rowTotal - 1; i++){

            address = splitSpace(hotelAdapter.getAddress(i));
            hotel = hotelAdapter.getTitle(i);
